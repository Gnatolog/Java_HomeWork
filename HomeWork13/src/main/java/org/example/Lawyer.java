...
public class Lawyer implements Observer{
    ...
    public void receiveoffer(String nameCompany, String name_vacancy, String type_vacancy, int salary) {
        if(this.salary <= salary){
            System.out.printf("Юрист %s: Мне нужна этат работа! (компания: %s; вакансия: %s заработная плата: %d\n",
            ...
            System.out.printf("Юрист %s: Я найду работу получше! (компания: %s; вакансия: %s заработная плата: %d\n",
                    name,nameCompany,name_vacancy,salary);
        }
    ...
    //region Constructor
    public Lawyer(String name, String profession) {
        this.name = name;
